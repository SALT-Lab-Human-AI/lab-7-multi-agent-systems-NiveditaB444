...
class AgentConfig:
    ...
    RESEARCH_AGENT = {
        "name": "ResearchAgent",
        "role": "Senior Market Research Analyst with 10+ years in tech industry",  # ← Modified
        "temperature": 0.7,
    }

    ANALYSIS_AGENT = {
        "name": "AnalysisAgent",
        "role": "Strategic Product Analyst specializing in AI applications",  # ← Modified
        "temperature": 0.7,
    }

    BLUEPRINT_AGENT = {
        "name": "BlueprintAgent",
        "role": "Lead UX Designer with expertise in interview platforms",  # ← Modified
        "temperature": 0.7,
    }

    REVIEWER_AGENT = {
        "name": "ReviewerAgent",
        "role": "Chief Product Officer with 15+ years experience",  # ← Modified
        "temperature": 0.7,
    }
...
class AgentConfig:
    ...
    RESEARCH_AGENT = {
        "name": "ResearchAgent",
        "role": "Senior Market Research Analyst with 10+ years in tech industry",
        "temperature": 0.7,
    }

    ANALYSIS_AGENT = {
        "name": "AnalysisAgent",
        "role": "Strategic Product Analyst specializing in AI applications",
        "temperature": 0.7,
    }

    BLUEPRINT_AGENT = {
        "name": "BlueprintAgent",
        "role": "Lead UX Designer with expertise in interview platforms",
        "temperature": 0.7,
    }

    TECHNICAL_AGENT = {  # ← NEW AGENT ADDED
        "name": "TechnicalAgent", 
        "role": "Senior AI Engineer with expertise in ML systems and scalability",
        "temperature": 0.7,
    }

    REVIEWER_AGENT = {
        "name": "ReviewerAgent",
        "role": "Chief Product Officer with 15+ years experience",
        "temperature": 0.7,
    }
...
class WorkflowConfig:
    ...
    TASK_DESCRIPTIONS = {
        ...
        "analysis": "Identify 3 key market opportunities and gaps",
        "blueprint": "Create product blueprint with features and user flows",
        "technical": "Assess technical feasibility and implementation requirements",  # ← NEW TASK ADDED
        "review": "Review blueprint and provide strategic recommendations",
    }